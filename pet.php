...
?>
    ...
    <head>
        ...
        <link rel="stylesheet"
              href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> <!--LogOut-->
    </head>
    <body>
    <div class="container">
...
//                            echo mb_detect_encoding($row["name"]);
                            ...
                            <form class='info-buy' onsubmit='event.preventDefault(); addToCart();' method='POST'>
                            <input type='hidden' id='pet' name='pet' value=\"", $row["pet_id"], "\">
                            <input type='submit' id='submitCart' class='submitCart' value='Add to cart'>
                            </form>";
