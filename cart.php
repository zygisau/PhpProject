...
//                                        location.reload();
                    ...
                    <tr>
                        ...
                        function calculate() {
                            total.innerHTML = array.reduce(getSum) + " €";
                        }
                        </script>
                    </tr>
                    <tr>
                        <td colspan="6" align="right"><form action="proceedToPayment.php" method="POST" class="proceed"><input type="submit" value="PROCEED TO CHECKOUT"></form></td>
                    </tr>
                </tbody>
                </table>';
                    } else {
